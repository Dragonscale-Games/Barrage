...
{ 
  ...
  class FramerateController
  {
    public:
      ...
      */
      /**************************************************************/
      void Initialize(FpsCap fpsCap, bool useVsync);
      ...
      */
      ...
      /*!
        ...
        \param minimizeCpuUsage
          When true:
          - If vsync is on, blocks until vblank interval.
          - If vsync is off, blocks using sleep() until minimum frame
            time is reached. This provides lower CPU usage at the
            cost of higher input latency.
          When false:
          - Blocks using busy wait until minimum frame time is
            reached. This provides lower input latency at the cost 
            of heavy CPU usage.
      */
      /**************************************************************/
      void EndFrame(bool minimizeCpuUsage);
